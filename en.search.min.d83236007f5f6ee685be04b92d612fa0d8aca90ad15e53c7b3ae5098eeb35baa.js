...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.43bbba3def46bf49a733e6b1f8853d8a798c6e0ec04d2f35946a337fe1eb895c.js',function(){input.required=false;search();});}
