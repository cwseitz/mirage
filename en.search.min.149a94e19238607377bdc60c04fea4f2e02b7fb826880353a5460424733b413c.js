...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mirage/flexsearch.min.js');loadScript('/mirage/en.search-data.min.7d67955d31602b4592e5bcba90c55b4a24ba88c599a9a9a2fa91bac10dcd0743.js',function(){input.required=false;search();});}
